...
export async function suggestTopic(topicName: string): Promise<TopicSuggestion> {
  const res = await fetch(`${API_URL}/api/topics/suggest`, {
    method: "POST",
...
export async function createTopic(data: TopicSuggestion): Promise<TopicData> {
  const res = await fetch(`${API_URL}/api/topics/create`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
export async function runTopicPipeline(slug: string, options?: { hours?: number; maxPages?: number }): Promise<void> {
  ...
  const res = await fetch(`${API_URL}/api/topics/${slug}/run${qs}`, {
    method: "POST",
  });
...
export async function fetchFeed(
  ...
  const res = await fetch(`${API_URL}/api/feed?${params}`, { cache: "no-store" });
...
export async function fetchGapAnalysis(topic: string): Promise<GapAnalysisData | null> {
  const res = await fetch(`${API_URL}/api/gap-analysis?topic=${encodeURIComponent(topic)}`, { cache: "no-store" });
  if (!res.ok) return null;
  return res.json();
}

export async function fetchNarrative(topic: string): Promise<NarrativeData | null> {
  const res = await fetch(`${API_URL}/api/narrative?topic=${encodeURIComponent(topic)}`, {
    cache: "no-store",
  });
  if (!res.ok) return null;
  return res.json();
...
export async function fetchRecommendations(topic: string): Promise<RecommendationsData | null> {
  const res = await fetch(`${API_URL}/api/recommendations?topic=${encodeURIComponent(topic)}`, { cache: "no-store" });
  if (!res.ok) return null;
  return res.json();
}
...
export async function fetchExposureOverlap(topic: string): Promise<ExposureOverlapData | null> {
  const res = await fetch(`${API_URL}/api/exposure-overlap?topic=${encodeURIComponent(topic)}`, { cache: "no-store" });
  if (!res.ok) return null;
  return res.json();
}
...
export async function fetchPairedStories(topic: string): Promise<PairedStoriesData | null> {
  const res = await fetch(`${API_URL}/api/paired-stories?topic=${encodeURIComponent(topic)}`, { cache: "no-store" });
  if (!res.ok) return null;
  return res.json();
}
...
export async function fetchAnalytics(topic: string): Promise<AnalyticsData | null> {
  const res = await fetch(`${API_URL}/api/analytics?topic=${encodeURIComponent(topic)}`, {
    cache: "no-store",
  });
  if (!res.ok) return null;
  return res.json();
...
export async function fetchNarrativeDepth(topic: string): Promise<NarrativeDepthData | null> {
  const res = await fetch(`${API_URL}/api/narrative-depth?topic=${encodeURIComponent(topic)}`, {
    cache: "no-store",
  });
  if (!res.ok) return null;
  return res.json();
...
export async function fetchMediaBreakdown(topic: string): Promise<MediaBreakdownData | null> {
  const res = await fetch(`${API_URL}/api/media-breakdown?topic=${encodeURIComponent(topic)}`, {
    cache: "no-store",
  });
  if (!res.ok) return null;
  return res.json();
...
export async function fetchHashtags(topic: string): Promise<HashtagData | null> {
  const res = await fetch(`${API_URL}/api/hashtags?topic=${encodeURIComponent(topic)}`, {
    cache: "no-store",
  });
  if (!res.ok) return null;
  return res.json();
...
export async function fetchLastRun(topic: string): Promise<LastRunData | null> {
  const res = await fetch(`${API_URL}/api/last-run?topic=${encodeURIComponent(topic)}`, {
    cache: "no-store",
  });
  if (!res.ok) return null;
  return res.json();
...
export async function fetchPipelineProgress(slug: string): Promise<PipelineProgress | null> {
  const res = await fetch(`${API_URL}/api/topics/${slug}/progress`, { cache: "no-store" });
  if (!res.ok) return null;
  return res.json();
}

export async function fetchSideBySideFeed(topic: string): Promise<SideBySideFeedData | null> {
  const res = await fetch(`${API_URL}/api/side-by-side-feed?topic=${encodeURIComponent(topic)}`, {
    cache: "no-store",
  });
  if (!res.ok) return null;
  return res.json();
...
export async function fetchDunks(topic: string): Promise<DunksData | null> {
  const res = await fetch(`${API_URL}/api/dunks?topic=${encodeURIComponent(topic)}`, {
    cache: "no-store",
  });
  if (!res.ok) return null;
  return res.json();
...
export async function fetchNarrativeStrategy(topic: string): Promise<NarrativeStrategyData | null> {
  const res = await fetch(`${API_URL}/api/narrative-strategy?topic=${encodeURIComponent(topic)}`, {
    cache: "no-store",
  });
  if (!res.ok) return null;
  return res.json();
...
export async function fetchPulseExtras(topic: string): Promise<PulseExtrasData | null> {
  const res = await fetch(`${API_URL}/api/pulse-extras?topic=${encodeURIComponent(topic)}`, {
    cache: "no-store",
  });
  if (!res.ok) return null;
  return res.json();
...
export async function fetchSummaries(
  ...
  const res = await fetch(`${API_URL}/api/summaries?topic=${encodeURIComponent(topic)}`, {
    cache: "no-store",
  });
  if (!res.ok) return {};
  return res.json();
...
export async function fetchAllTweets(
  ...
  const res = await fetch(`${API_URL}/api/feed/all?${params}`, { cache: "no-store" });
...
export async function fetchSmartFeed(
  ...
  const res = await fetch(`${API_URL}/api/feed/smart?${params}`, { cache: "no-store" });
  if (!res.ok) return [];
  return res.json();
}
...
export async function fetchBreakdown(
  ...
  const params = new URLSearchParams({ topic, hours: String(hours) });
  const res = await fetch(`${API_URL}/api/breakdown?${params}`, { cache: "no-store" });
...
export async function fetchAdminTweets(
  ...
  const res = await fetch(`${API_URL}/api/admin/tweets?${params}`, {
    cache: "no-store",
...
export async function fetchAdminStats(
  ...
  const res = await fetch(`${API_URL}/api/admin/stats?${p}`, {
    cache: "no-store",
    headers: { "X-Admin-Secret": adminSecret },
  });
...
export async function submitOverride(
  ...
  const res = await fetch(`${API_URL}/api/override`, {
    method: "POST",
    headers: {
...
export async function fetchTopicDetail(slug: string): Promise<TopicDetail> {
  const res = await fetch(`${API_URL}/api/topics/${slug}`, { cache: "no-store" });
...
export async function updateTopic(
  ...
  const res = await fetch(`${API_URL}/api/topics/${slug}`, {
    method: "PUT",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
  });
...
export async function deleteTopic(slug: string): Promise<void> {
  const res = await fetch(`${API_URL}/api/topics/${slug}`, { method: "DELETE" });
  if (!res.ok) throw new Error("Failed to delete topic");
}

export async function fetchTopicRuns(slug: string): Promise<PipelineRun[]> {
  const res = await fetch(`${API_URL}/api/topics/${slug}/runs`, { cache: "no-store" });
